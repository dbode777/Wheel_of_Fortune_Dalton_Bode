...
# Wheel options
wheel_options = ["BANKRUPT",str(550),str(850),str(900),str(700),str(600),str(650),str(300),str(700),"Lose a Turn",str(600),str(550),str(500),str(600),
                 "BANKRUPT",str(650),str(100),str(800),"Lose a Turn",str(800),str(750),str(650),str(500),str(150)]
